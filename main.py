...
class WebScrapping:
    def __init__(self):
        ...
        # only use if I can get more players, only recording 30 players, was able to get up to  45 before timing out
...
def create_player_dict(self):
    ...
    # while self.count > 0:
    for i in range(1, 31):
        wait = WebDriverWait(self.driver, timeout=15, poll_frequency=2)
